...
// ✅ ВАШ URL ВЕБ-ПРИЛОЖЕНИЯ APPS SCRIPT (вставлен)
const GOOGLE_APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyITVJpwlVnv3RITeA1OlvelKtKXAJpLf41xFKKpSAs17J4sq8OsLy4zDTb2yo4gfyL/exec';
...
async function initializeModel() {
    try {
        ...
        reviewDisplay.textContent = '⚠️ AI model could not be loaded.';
        isModelReady = false;
